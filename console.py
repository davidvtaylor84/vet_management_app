...
pet1 = Pet('Captain Purrcard', '21/02/2015', 'Cat', 'Persian', 'Mike Rophone', 'Bit of a sore leg', vet3)
pet_repository.save(pet1)
pet2 = Pet('Karl Barx', '02/03/2020', 'Dog', 'Irish Wolfhound', 'Helen Hywater', 'Listless and depressed', vet2)
